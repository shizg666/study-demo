...
public class StringUtil {
     ...
     * @return
     */
    public static String join(List<String> data,String joinStr){
        Joiner joiner = Joiner.on(joinStr).skipNulls();
     ...
     * @return
     */
    public static String join(String [] data,String joinStr){
        Joiner joiner = Joiner.on(joinStr).skipNulls();
        return joiner.join(data);
    }
